      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 8;
            return _promise2.default.all([dockerApiGet(containersUrl), dockerApiGet(imagesUrl), dockerApiGet(infoUrl), dockerApiGet(versionUrl), dockerApiGet(volumesUrl), dockerApiGet(networksUrl)]);

          case 8:
            r = _context.sent;
            _context.next = 11;
            return _promise2.default.all(r[1].map(function (img) {
