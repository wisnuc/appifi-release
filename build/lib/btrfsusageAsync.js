    ...
    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _promise2.default.all([btrfs_filesystem_usage(mountpoint), btrfs_device_usage(mountpoint)]);
...
btrfs_usage('/run/wisnuc/volumes/79575a8e-673f-4d00-92ee-c338023ec754').then(function (result) {
