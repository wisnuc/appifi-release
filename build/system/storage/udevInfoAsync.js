      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0, _bluebird.resolve)(child.execAsync('udevadm info ' + sysfspath));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            props = [], p = null;
            _context2.next = 3;
            return (0, _bluebird.resolve)(child.execAsync('udevadm info -a ' + sysfspath));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.t1 = {};
            _context3.next = 4;
            return (0, _bluebird.resolve)(udevInfo(path));

          case 4:
            _context3.t2 = _context3.sent;
            _context3.next = 7;
            return (0, _bluebird.resolve)(udevInfoAttr(path));

          case 7:
            _context3.t3 = _context3.sent;
            _context3.t4 = {
              sysfsProps: _context3.t3
            };
